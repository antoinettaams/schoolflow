...
// --- Données simulées (événements pour professeurs) ---
const allEvents = [
    // OCTOBRE
    ...
    // NOVEMBRE
    { id: 5, date: "01 Novembre", day: "JEU", title: "Toussaint - Jour Férié", type: "Congé", location: "École Fermée", icon: AlertCircle, color: "bg-green-500", badge: "Congé", month: "Novembre", time: "Toute la journée" },
    { id: 6, date: "11 Novembre", day: "DIM", title: "Armistice 1918", type: "Congé", location: "École Fermée", icon: AlertCircle, color: "bg-green-500", badge: "Congé", month: "Novembre", time: "Toute la journée" },
    { id: 7, date: "15 Novembre", day: "JEU", title: "Olympiades de Sciences", type: "Compétition", location: "Laboratoire de Physique", icon: Users, color: "bg-purple-500", badge: "Compétition", month: "Novembre", time: "14:00 - 17:00" },

    // DÉCEMBRE
    { id: 8, date: "05 Décembre", day: "MAR", title: "DS d'Histoire-Géographie", type: "Examen", location: "Salle 201", icon: ClipboardList, color: "bg-red-500", badge: "Important", month: "Décembre", time: "09:00 - 11:00" },
    { id: 9, date: "15 Décembre", day: "VEN", title: "Fête de Noël de l'École", type: "Fête", location: "Cantine principale", icon: Sun, color: "bg-yellow-500", badge: "Fête", month: "Décembre", time: "18:00 - 22:00" },
    { id: 10, date: "18 Décembre", day: "LUN", title: "Concert de Noël", type: "Fête", location: "Auditorium", icon: Sun, color: "bg-yellow-500", badge: "Fête", month: "Décembre", time: "19:00 - 21:00" },
    { id: 11, date: "20 Décembre", day: "MER", title: "Remise des Bulletins", type: "Réunion", location: "Salle des Professeurs", icon: Users, color: "bg-blue-500", badge: "Important", month: "Décembre", time: "16:00 - 18:00" },
];

// Types d'événements pour filtres
const eventTypes = ["Tous", "Examen", "Réunion", "Voyage", "Congé", "Compétition", "Fête"];
...
const TeacherEvents = () => {
    ...
    return (
        <div className="flex flex-col h-screen bg-gray-50 overflow-hidden lg:pl-5 pt-20 lg:pt-6">
            ...
            {/* Header */}
            <header className="border-b border-gray-200 p-4 sm:p-6 sticky top-0 z-10 shadow-sm bg-gray-50">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900">Événements scolaires</h1>
                        <p className="text-gray-500 text-sm sm:text-base">{filteredEvents.length} événement(s) trouvé(s)</p>
                    </div>

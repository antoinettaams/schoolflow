...
const initialProfileData = {
  firstName: "Monsieur",
  lastName: "Lebrun",
  email: "m.lebrun@schoolflow.com",
  profileImageUrl: "https://placehold.co/150x150/3b82f6/ffffff?text=ML",
  role: "Professeur",
...
const TeacherProfilePage = () => {
  ...
  const handleImageUpload = () => {
    ...
    const newUrl = "https://placehold.co/150x150/10b981/ffffff?text=Nouveau+ML";
            ...
            <div className="pt-16 pb-6 px-8 border-b border-gray-100">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  ...
                  <p className="text-lg font-bold text-gray-800">{profileData.subject}</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 border-t border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div>
                    <p className="text-xs font-medium text-gray-500 uppercase">Matière Enseignée</p>
                    <p className="text-gray-800 font-semibold">{profileData.subject}</p>
                  </div>
                </div>
                <div className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  <GraduationCap className="w-5 h-5 text-green-600 mr-4 flex-shrink-0" />
                  <div>
                    <p className="text-xs font-medium text-gray-500 uppercase">Classes Assignées</p>

    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="h-screen overflow-y-auto">
        <div className="max-w-6xl mx-auto p-6 space-y-6">
          {/* ✅ Carte de profil - IDENTIQUE À L'ADMIN */}
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 relative">
            ...
            {/* Menu des options d'image - IDENTIQUE À L'ADMIN */}
            {showImageOptions && (
              <>
            ...
            {/* Image Modal - IDENTIQUE À L'ADMIN */}
            {showImageModal && (
            ...
            {/* Nom et rôle - ADAPTÉ POUR PROFESSEUR */}
            ...
            {/* Informations personnelles - IDENTIQUE À L'ADMIN */}
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <Info
                  ...
                  icon={Mail}
                />
                <Info label="Téléphone" value={teacherInfo.phoneNumber} icon={Phone} />
              </div>
            </div>

            {/* Informations professionnelles - SPÉCIFIQUE PROFESSEUR */}
            <div className="p-6 border-t border-gray-100">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <Info label="Matière" value={teacherInfo.subject} icon={BookOpen} />
                <Info label="Classes" value={teacherInfo.class} icon={GraduationCap} />
                <Info label="Expérience" value={teacherInfo.yearsExperience} icon={User} />
                <Info label="ID Utilisateur" value={user.id} icon={User} />
              </div>
            </div>

            {/* Date création + bouton - IDENTIQUE À L'ADMIN */}
          ...
          {/* Section sécurité - IDENTIQUE À L'ADMIN */}
          <Section
          ...
          {/* Mes Cours - SPÉCIFIQUE PROFESSEUR */}
          <Section
            title="Mes Cours"
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                ...
                <div>
                  <p className="text-sm font-medium">Mathématiques - Terminale S2</p>
              ...
              <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                ...
                <div>
                  <p className="text-sm font-medium">Mathématiques - Première S1</p>
              ...
              <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-lg">
                ...
                <div>
                  <p className="text-sm font-medium">Soutien Mathématiques</p>
      ...
      {/* Modale de déconnexion - IDENTIQUE À L'ADMIN */}
      {isLogoutModalOpen && (

...
const SecretaireSettingsPage = () => {
  ...
  const handleProfileUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("Profil secrétaire mis à jour avec succès !");
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col lg:pl-5 pt-20 lg:pt-6">
      ...
      {/* Contenu principal */}
      <div className="flex-1 overflow-y-auto lg:pl-5 pt-20 lg:pt-6">
        <div className="max-w-4xl mx-auto p-6 flex flex-col gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900">Profil Secrétaire</h2>
                    ...
                    <form onSubmit={handleProfileUpdate} className="space-y-4">
                      ...
                      <div className="flex justify-end">
                        <button
                          type="submit"
                          disabled={isLoading}
                          className="bg-pink-600 hover:bg-pink-700 text-white font-medium py-2 px-6 rounded-lg transition-colors shadow-sm focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 disabled:opacity-50 flex items-center gap-2"
                        >
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Protégez votre compte secrétaire</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Détails de votre compte secrétaire</p>
              </div>
            </div>

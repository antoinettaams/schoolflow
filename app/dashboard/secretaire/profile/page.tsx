// app/dashboard/secretaire/profile/page.tsx
"use client";
...
const SecretaireProfilePage = () => {
  ...
  const getUserActivity = (): UserActivity[] => [
    ...
    },
    {
      ...
      description: "Document administratif traité",
  ...
  const profileImage = user.imageUrl || "https://placehold.co/150x150/ec4899/ffffff?text=S";
...
export default SecretaireProfilePage;
...
const ParentSettingsPage = () => {
  ...
  useEffect(() => {
    if (isLoaded && !user) {
      ...
      if (role !== "parent") {
        alert("🚫 Accès réservé aux parents uniquement !");
  ...
  const handleProfileUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("✅ Profil parent mis à jour avec succès !");
        ...
        <div className="max-w-4xl mx-auto p-6 flex flex-col gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900">Profil Parent</h2>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Protégez votre compte parent</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Détails de votre compte parent</p>
              </div>
            </div>

...
// Données fictives du parent
const initialProfileData = {
  firstName: "Marie",
  lastName: "Dupont",
  email: "marie.dupont@gmail.com",
  profileImageUrl: "https://placehold.co/150x150/3b82f6/ffffff?text=MD",
  role: "Parent",
...
const ParentProfilePage = () => {
  ...
  const handleImageUpload = () => {
    ...
    const newUrl = "https://placehold.co/150x150/10b981/ffffff?text=Nouveau+MD";
  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-col lg:pl-5 pt-20 lg:pt-6">
            ...
            <div className="pt-16 pb-6 px-8 border-b border-gray-100">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  <p className="text-sm text-gray-500">Enfant(s) à charge</p>
                  <p className="text-lg font-bold text-gray-800">{profileData.children.length}</p>
                </div>
              </div>
            </div>
                  ...
                  <div key={index} className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="flex items-center p-4 bg-white rounded-lg border border-gray-200">
                        <User className="w-5 h-5 text-green-600 mr-4 flex-shrink-0" />
                        <div>
                          <p className="text-xs font-medium text-gray-500 uppercase">Nom de l'Enfant</p>
                      ...
                      <div className="flex items-center p-4 bg-white rounded-lg border border-gray-200">
                        ...
                        <div>
                          <p className="text-xs font-medium text-gray-500 uppercase">Classe / Filière</p>
                          <p className="text-gray-800 font-semibold">{child.class}</p>
                        </div>
                      </div>
                      <div className="flex items-center p-4 bg-white rounded-lg border border-gray-200">
                        ...
                        <div>
                          ...
                          <p className="text-gray-800 font-semibold">{child.studentId}</p>
                        </div>
                      </div>
                    </div>
                  </div>

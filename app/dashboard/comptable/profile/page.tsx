...
const ComptableProfilePage = () => {
  ...
  const getUserActivity = () => [
    ...
    },
    {
      ...
      description: "Rapport financier créé",
  ...
  const profileImage = user.imageUrl || "https://placehold.co/150x150/f97316/ffffff?text=CP";
      ...
      <div className="h-screen overflow-y-auto">
        <div className="max-w-6xl mx-auto p-6 space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 relative">
            {/* Bannière */}
            <div className="bg-gradient-to-r from-orange-500 to-amber-600 h-40 w-full relative">
              <div className="absolute left-8 bottom-0 translate-y-1/2">
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute bottom-0 right-0 p-2 bg-orange-600 text-white rounded-full border-2 border-white shadow-lg hover:bg-orange-700 transition-transform transform hover:scale-110 disabled:opacity-50"
                  >
                    {isUploading ? (
              ...
              <>
                <div className="absolute left-8 top-48 mt-2 w-64 bg-white rounded-xl shadow-2xl border border-gray-200 z-50 overflow-hidden">
                  <button
                    ...
                    disabled={isUploading}
                    className="w-full flex items-center gap-3 px-4 py-3 text-left hover:bg-orange-50 border-b border-gray-100"
                  >
            ...
            <div className="pt-16 pb-6 px-8 border-b border-gray-100">
              ...
              <p className="text-orange-600 font-medium">Comptable</p>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <Info label="Prénom" value={user.firstName || ""} icon={User} color="orange" />
                <Info label="Nom" value={user.lastName || ""} icon={User} color="orange" />
                <Info
                  label="E-mail"
                  ...
                  color="orange"
                />
                <Info label="ID Utilisateur" value={user.id} icon={User} color="orange" />
              </div>
            </div>

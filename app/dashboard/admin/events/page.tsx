      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
            <div className="h-10 bg-gray-200 rounded-lg animate-pulse flex-1 sm:flex-none sm:w-64"></div>
...
const EmptyStateSkeleton: React.FC = () => {
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 text-center py-12 animate-pulse">
...
const ModalSkeleton: React.FC = () => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl border w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-pulse">
        {/* En-tête Modal Skeleton */}
...
export default function EventsPage() {
  ...
  const handleEdit = (event: SchoolEvent) => {
    if (!canModify) {
      toast.error("Vous n'avez pas les permissions pour modifier un événement");
      return;
    }
  ...
  const handleDelete = async (id: string) => {
    if (!canModify) {
      toast.error("Vous n'avez pas les permissions pour supprimer un événement");
      return;
    }
              ...
              <div className="bg-white p-4 sm:p-6 border-t border-gray-200 sticky bottom-0">
                <div className="flex flex-col sm:flex-row gap-2 justify-end">
                  ...
                  <button
                    onClick={handleSave}
                    disabled={isSubmitting}
                    className="flex items-center justify-center gap-2 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors order-1 sm:order-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (

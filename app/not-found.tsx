  ...
  return (
    ...
    <div className="h-screen bg-black text-white flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center flex flex-col items-center justify-center h-full">
        ...
        {/* 404 Glitch Effect - Tailles de police réduites */}
        {/* Réduction de la marge inférieure (mb-6 au lieu de mb-8 md:mb-12) */}
        <div className="font-title flex items-center justify-center mb-6 flex-none">
          <div className="relative">
            
            {/* Le nombre 4-Robot-4 - TAILLES CLÉS RÉDUITES */}
            ...
            >
              ...
              {/* Emoji robot central - Taille légèrement réduite */}
        ...
        {/* Message d'erreur - Marge réduite */}
